<h1><?php echo Yii::t('TranslationModule.base', 'Translation manager'); ?></h1>

<hr>
<?php echo CHtml::beginForm($this->createUrl('//translation/translate'), 'GET'); ?>
    <?php echo CHtml::dropDownList('moduleId', $moduleKey, $modules, array('onChange'=>'this.form.submit();')); ?>
    <?php echo CHtml::dropDownList('language', $languageKey, $languages, array('onChange'=>'this.form.submit();')); ?>
    <?php echo CHtml::dropDownList('category', $categoryKey, $categories, array('onChange'=>'this.form.submit();')); ?>
    <span style='color:red'>Save before change!</span>
<?php echo CHtml::endForm(); ?>

<!--
<p>Current Module: <?php echo $moduleId; ?> - Current Language: <?php echo $language; ?> - Current Section: <?php echo $category; ?></p>
-->
<hr>
