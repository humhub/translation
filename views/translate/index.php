        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <?php $i = 0; ?>
                    <p>
                        <?= Yii::t('TranslationModule.views_translate_index', 'If the value is empty, the message is considered as not translated.'); ?>
                        <?= Yii::t('TranslationModule.views_translate_index', 'Messages that no longer need translation will have their translations enclosed between a pair of "@@" marks.'); ?>
