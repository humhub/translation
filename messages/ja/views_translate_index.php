...
return array (
  ...
  'For more informations about translation syntax see' => '変換構文の詳細については、次を参照して下さい。',
  'If the value is empty, the message is considered as not translated.' => '値が空の場合、メッセージは翻訳されていないと見なされます。',
  'Message string can be used with plural forms format. Check i18n section of the documentation for details.' => 'メッセージ文字列は複数形で使用できます。詳細については、ドキュメントの i18n セクションを確認して下さい。',
